...
Users are able to verify whether a project's offset goals are being acheived by easily monitoring any changes to the tree coverage occurring within a project's boundaries.
