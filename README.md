...
Users are able to verify whether a project's offset goals are being acheived by observing changes to the tree coverage occuring within a project's boundaries.
