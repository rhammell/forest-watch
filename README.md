...
Users are able to verify whether a project's offset goals are being acheived by observing any changes to the tree coverage occuring inside the project's boundaries.
