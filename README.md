...
Users are able to verify whether a project's offset goals are being achieved by observing changes to tree coverage happening within a project's boundaries.
