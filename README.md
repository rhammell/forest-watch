...
Users are able to verify whether a project's offset goals are being acheived by observing any changes to the tree coverage occurring inside the project's boundaries.
